...
public class RecommendationSystem {
    ...
    private static final int MIN_BMI = 100; //placeholder

    private static final int MAX_BMI = 150; //placeholder
...
//        // Analyze heart rate
        ...
        if (heartRate > MAX_HEART_RATE) {
            recommendations.add("Your heart rate is higher than the recommended range. " +
                    "Consider decreasing your physical activity to improve your cardiovascular health.");
        }
//
//        // Analyze steps
...
//        // Add more health data analysis and recommendations as needed
        double weight = healthData.getWeight(); //lbs
        double height = healthData.getHeight(); //inches
        // Calculate BMI
        //
        double heightsqrd = height * height;
        double bmi = (weight/heightsqrd)*703;
        if (weight < MIN_BMI) {
